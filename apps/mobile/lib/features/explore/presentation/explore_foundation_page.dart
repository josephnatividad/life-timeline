...
final class _ExploreContent extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final hasBrowseContent =
        overview.things.isNotEmpty ||
        overview.places.isNotEmpty ||
        overview.years.isNotEmpty ||
        overview.categories.isNotEmpty;
    if (overview.insights.isEmpty && !hasBrowseContent) {
      return ScreenContainer(
        child: ListView(
          key: const Key('explore-empty-content'),
          children: [
            Text(
            ...
            AppEmptyState(
              ...
              message:
                  'Add confirmed memories to reveal useful patterns and ways to browse your life.',
