enum AppRoute {
  ...
  memoryGallery(name: 'memory-gallery', path: '/memory/:memoryId/photos'),
  memoryEvidence(name: 'memory-evidence', path: '/memory/:memoryId/evidence'),
  ...
  insights(name: 'insights', path: '/explore/insights'),
  ...
  storyMemorySources(
    name: 'story-memory-sources',
    path: '/stories/sources/memories',
  ),
  thenNowSelection(name: 'then-now-selection', path: '/stories/then-now'),
  storageManager(name: 'storage-manager', path: '/storage'),
  storageArchive(name: 'storage-archive', path: '/storage/archive'),
